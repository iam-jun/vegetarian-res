...
object AppContants {
    ...
    val CATEGORIES_DATA = arrayOf("Salad", "Noodles", "Cake", "Drinks", "Soup")

    val NAME_DATA = arrayOf("Cucumber", "Tomato", "Potato", "Kale caesar","Walnut", "Avocado", "Pineapple", "Sesame Soy Tofu")
